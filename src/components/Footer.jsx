    ...
    <footer className="bg-primary text-white pt-16 pb-8 border-t-4 border-accent">
      <div className="container mx-auto px-4 md:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          ...
          <div>
            <Link href="/" className="block mb-6 cursor-pointer">
              <img
                src={logo}
                alt="MMT Resorts"
                className="h-16 bg-white/10 rounded-lg p-2 backdrop-blur-sm"
              />
            </Link>
            ...
            <div className="flex gap-4">
              {/* Facebook */}
              <a
                href="https://www.facebook.com/mano.unique.3"
                target="_blank"
              ...
              {/* Instagram */}
              <a
                href="https://www.instagram.com/ecrbeachvilla/"
                target="_blank"
                rel="noopener noreferrer"
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-xl font-serif font-bold mb-6 text-accent">
              Explore
            </h3>
            <ul className="space-y-4">
              <li>
                <Link
                  href="/villas"
                  className="text-gray-300 hover:text-accent transition-colors cursor-pointer flex items-center gap-2"
                >
                  <span className="text-accent">›</span> All Villas
                </Link>
              </li>
              <li>
                <Link
              ...
              <li>
                <Link
                  ...
                  className="text-gray-300 hover:text-accent transition-colors cursor-pointer flex items-center gap-2"
                >
                  <span className="text-accent">›</span> Private Pools
                </Link>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-6">
              ...
              <li className="flex items-center gap-4 text-gray-300">
                ...
                <span className="font-light">+91 9080399924 </span>
              </li>
              <li className="flex items-center gap-4 text-gray-300">
                <Mail className="text-accent shrink-0" size={20} />
                <span className="font-light">mmtresorts@gmail.com</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-white/10 pt-8 text-center text-gray-400 text-sm font-light">
          <p>
            &copy; {new Date().getFullYear()} MMT Resorts. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
